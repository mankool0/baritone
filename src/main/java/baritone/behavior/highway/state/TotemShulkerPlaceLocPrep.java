...
public class TotemShulkerPlaceLocPrep extends State {
    public TotemShulkerPlaceLocPrep(HighwayState state) {
        super(state);
    }
    ...
    public void handle(HighwayContext context) {
        ...
        context.transitionTo(HighwayState.GoingToPlaceLocTotemShulker);
    }
}
