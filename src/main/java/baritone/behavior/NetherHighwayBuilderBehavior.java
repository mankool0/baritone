...
public final class NetherHighwayBuilderBehavior extends Behavior implements INetherHighwayBuilderBehavior, IRenderer {
    ...
    private final List<BlockState> approxPlaceable = new ArrayList<BlockState>() {};
    ...
    private static final List<ItemLike> shulkerItemList = Arrays.asList(Items.WHITE_SHULKER_BOX, Items.ORANGE_SHULKER_BOX, Items.MAGENTA_SHULKER_BOX, Blocks.LIGHT_BLUE_SHULKER_BOX,
            ...
            case LiquidRemovalPathing: {
                ...
                for (Direction side : Direction.values()) {//(int i = 0; i < 5; i++) {
                    ...
                    if (MovementHelper.canPlaceAgainst(ctx, against1)) {
                        ...
                        if (res != null && res.getType() == HitResult.Type.BLOCK && ((BlockHitResult) res).getBlockPos().equals(against1) && ((BlockHitResult) res).getBlockPos().relative(((BlockHitResult) res).getDirection()).equals(sourceBlocks.get(0))) {
