...
public class CustomExploreCommand extends Command {

    public CustomExploreCommand(IBaritone baritone) {
        super(baritone, "customexplore");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        baritone.getCustomExploreProcess().explore(pointsDist, start.getX(), start.getZ(), end.getX(), end.getZ());
